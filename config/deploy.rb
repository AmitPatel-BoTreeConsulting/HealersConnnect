...
namespace :deploy do
  ...
  # Added task generate_assets to prepare assets for 'jammit' gem
  # It's necessary to do this after deploy
  # Otherwise cleanup would delete all assets generated by this
  # http://stackoverflow.com/questions/14834218/capistrano-deleting-assets
