module DonationsHelper
  ...
  def received_by_dropdown(donations, selected)
    ...
    select_tag("donation[user_id][]", options_for_select(options.uniq, selected[:user_id]), multiple: 'true', style: "display: none;", id: 'form-field-select-4', class: 'width-60 chosen-select')
  end
